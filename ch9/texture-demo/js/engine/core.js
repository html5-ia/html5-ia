...
var Engine = Class.extend({
    ...
    setup: function() {
        ...
        // Note: added for images
        // Loads in all of the textures and preps them
        this.initTextures();
    },
    ...
    initShaders: function() {
        ...
        // Note: shut off, turn back on
        //this.fragmentShader = this.getShader('shader-fs');
        //this.vertexShader = this.getShader('shader-vs');
        this.fragmentShader = this.getShader('fragment-shader-texture');
        this.vertexShader = this.getShader('vertex-shader-texture');
    ...
    initBuffers: function(object) {
        ...
        this.gl.bufferData(this.gl.ARRAY_BUFFER, new Float32Array(object.bufVert), this.gl.STATIC_DRAW); 
        
        // Note: Disabled, re-enable
        // Create color
        ...
        console.log(object.textureMap);
        this.gl.bufferData(this.gl.ARRAY_BUFFER, new Float32Array(object.textureMap), this.gl.STATIC_DRAW);
    ...
    initTextures: function() {
        ...
        this.cubeImage.onload = function() { self.handleTextureLoaded(self.cubeImage, self.cubeTexture); }
        this.cubeImage.src = "cubetexture.png";
    },
    ...
    draw: function() {
        ...
        for (var i in this.storage) {
            ...
            */
            ...
            this.gl.vertexAttribPointer(this.vertexPositionAttribute, this.storage[i].bufCols, this.gl.FLOAT, false, 0, 0); 
            
            // Note: Creates texture data
            this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.cubeVerticesTextureCoordBuffer);
